...
type
  ...
  public
    ...
    procedure Insert_UD_Detail(Num: string; Lat: string; Long: string; Time: string);
  end;
...
procedure TServerMethods1Client.Insert_UD_Detail(Num: string; Lat: string; Long: string; Time: string);
begin
  ...
  FInsert_UD_DetailCommand.Parameters[3].Value.SetWideString(Time);
