...
type
  ...
  public
    ...
    function get_count(value: string): string;
  end;
...
function TServerMethods1Client.get_count(value: string): string;
begin
  ...
  Result := Fget_countCommand.Parameters[1].Value.GetWideString;
end;
